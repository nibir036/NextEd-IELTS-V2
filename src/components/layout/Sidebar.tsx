                      ...
                      if (!hasDropdown) {
                        return (
                          <button
                            ...
                            className={`w-full flex items-center gap-3 px-3 py-2 text-[13px] rounded-xl font-medium transition-all duration-200 cursor-pointer [transform-style:preserve-3d] ${
                              isActive
                      ...
                      return (
                        <div key={item.id}>
                          ...
                          >
                            <button
                              onClick={() => onNavigate(item.id)}
                              className="flex-1 flex items-center gap-3 px-3 py-2 text-[13px] cursor-pointer min-w-0"
                            >
                              <Icon
                                size={16}
                                className={isActive ? 'text-white' : 'text-[var(--text-faint)] shrink-0'}
                          ...
                          {isDropdownOpen && (
                            <div className="pl-4 mt-0.5 space-y-0.5 border-l border-[var(--border)] ml-4">
                              {subItems === 'loading' ? (
                                <div className="px-3 py-2 text-xs font-mono text-[var(--text-faint)]">
                                  Loading...
                                </div>
                              ) : subItems.length === 0 ? (
                                <div className="px-3 py-2 text-xs font-mono text-[var(--text-faint)]">
                                ...
                                subItems.map((sub) => {
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`w-full text-left px-3 py-1.5 text-xs rounded-lg transition-colors cursor-pointer truncate ${
                                        subActive
